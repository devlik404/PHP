...
<body>
    ...
    <form action="" method="post">
        <input type="text" name="search" size="50" autofocus
        placeholder="cari anime......">
        <button type="submit" name="src">search</button>
 ...
 <?php foreach($listanime as $row) : ?>
    ...
    <tr>
        ...
        <td>
            ...
            <a href="delete.php?id=<?= $row["id"]; ?>" onclick = "return confirm('apakah anda ingin menghapusnya?');">hapus</a>
        </td>
